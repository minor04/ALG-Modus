...
class ALGModus extends IPSModule
	...
	public function ZeitPro(){
		...
		IPS_SetEventScript($EreignisID_bis, "$KategorieID_Zentral = IPS_GetCategoryIDByName("Zentral", 0); $InstanzID = IPS_GetInstanceIDByName("Modus", $KategorieID_Zentral); $VariabelID = IPS_GetVariableIDByName("AutoZSP", $InstanzID); SetValue($VariabelID, true);");
